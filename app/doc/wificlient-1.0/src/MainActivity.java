...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gets.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {//获取连接到消息发送的手机IP地址
                ...
                Toast.makeText(getApplicationContext(), "连接到手机上的Ip是："+resultList.toString(), Toast.LENGTH_LONG).show();
            }
        });
    ...
    public boolean setWifiApEnabled(boolean enabled) {
        ...
        try {
            ...
            Toast.makeText(MainActivity.this, "连接账号："+apConfig.SSID+",密码是："+apConfig.preSharedKey, Toast.LENGTH_LONG).show();//提示信息接收方要连接的热点账号和密码
            //返回热点打开状态
